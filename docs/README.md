...
| [BLOCK_LIBRARY.md](BLOCK_LIBRARY.md) | Complete table of all 61 block types (61 active, 2 deprecated) |
...
| File | Purpose |
|------|---------|
| `src/rung/types.h` | All 63 block types, 11 data types, RungCoil, implicit layouts, micro-header table, BlockDescriptor table |
